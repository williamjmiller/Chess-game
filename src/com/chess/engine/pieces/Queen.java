...
public class Queen extends Piece {
	...
	private final static int[] POTENTIAL_MOVE_VECTOR_COORDINATES = { -1, -7, -8, -9, 1, 7, 8, 9 };
	...
	// edge cases
		private static boolean isFirstColumnEx(final int currentPosition, final int potentialOffset) {
			...
			return BoardUtils.FIRST_COLUMN[currentPosition] && (potentialOffset == -1 || potentialOffset == -9 || potentialOffset == 7);
		}

		private static boolean isEighthColumnEx(final int currentPosition, final int potentialOffset) {
			return BoardUtils.EIGHTH_COLUMN[currentPosition] && (potentialOffset == 1 || potentialOffset == 9 || potentialOffset == -7);
		}
